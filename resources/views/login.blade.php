...
<section class="bg-gray-50 dark:bg-gray-900">
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="{{route('home')}}" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img class="w-8 h-8 mr-2" src="https://i.pinimg.com/originals/3c/63/10/3c63100127d896f366c1933622e65e97.png" alt="logo">
          GTI News    
      </a>
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="{{route('logar')}}" method="post">
                    @csrf
                    @if ($errors->any())
    <div class="alert bg-red-700 text-white text-center">
        <ul>
        ...
        @endif
                  ...
                  <div class="flex items-center justify-between">
                      ...
                      <a href="#" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Esqueci minha senha</a>
                  </div>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Ainda não criou sua conta? Clique<a href="#" class="font-medium text-blue-600 hover:underline dark:text-blue-500"> AQUI</a> e crie agora
                  </p>
              </form>
          </div>
      </div>
